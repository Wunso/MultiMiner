...
public class RomeoJuliet {
    ...
    public RomeoJuliet (AbstractScript ctx) {
        this.s = ctx;
    }
    ...
    // Romeo and Juliet completed (default false)
    private boolean romeoJulietCompleted = false;
    ...
    public int onLoop() {
        ...
        switch(currentState) {
            ...
            case COMPLETE:
                romeoJulietCompleted = true;
                s.log("Romeo and Juliet successfully completed!");
        }
        return 600;
    }
    ...
    // Disable roof in advanced options
    ...
    public boolean isRomeoJulietCompleted() {
        return romeoJulietCompleted;
    }
}
